...
function TermsAndConditions() {
  return (
    <div className="w-screen h-screen overflow-x-hidden">
      <div className="h-[10%] relative w-full z-20">
        <NavBar />
      </div>
      <section className="relative mx-auto max-w-3xl px-4 py-20 text-white">
        ...
        <div className="flex w-full items-center justify-center">
          <Link to={"/"}>
            <div className="py-3 px-6 bg-[#ae7aff] text-black font-bold shadow-[5px_5px_#4f4e4e] active:shadow-none active:translate-x-1 active:translate-y-1 flex flex-col text-center justify-center ">
              Conform
            </div>
          </Link>
        </div>
      </section>
      <div className="w-full bg-black h-[10%] border-t-2 border-white flex justify-between items-center px-2">
        <Link to={"/"}>
          <img src="/play.jpeg" className="size-14" />
        </Link>
        <p className="text-white">©2024 VideoTube. All rights reserved.</p>
      </div>
    </div>
  );
}
