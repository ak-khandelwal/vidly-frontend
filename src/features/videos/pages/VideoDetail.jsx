...
import {
  ...
  selectVideoLike,
  selectVideoPlay,
  selectVideoPlayStatus,
} from "../slice/videoSlice";
import { BiLike, BiSolidLike } from "react-icons/bi";
import {
  getSubscriber,
  toggleSubscription,
} from "../../subscribers/slice/SubscriberSlice";
function VideoDetail() {
  ...
  const handleSubscribe = async (e) => {
    ...
    const res = await dispatch(
      toggleSubscription({ channelId: video.owner._id })
    );
        ...
        <div className="w-full">
          ...
          <div className="border-2 rounded-t-xl p-4">
            ...
            <div className="flex justify-between mt-6">
              ...
              <div
                className={`w-28 py-2  text-black font-bold shadow-[5px_5px_#4f4e4e] active:shadow-none active:translate-x-1 active:translate-y-1 flex flex-col text-center justify-center ${
